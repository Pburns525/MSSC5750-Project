...
### cred hist length
ggplot(data=data %>% summarize(count=n(),.by=cb_person_cred_hist_length), aes(x= cb_person_cred_hist_length, y=count)) + geom_col(fill='steelblue') + ggtitle('Frequencies for credit history length')
